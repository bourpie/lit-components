 ...
 */
const t$1 = window.ShadowRoot && (window.ShadyCSS === void 0 || window.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, e$4 = Symbol(), n$5 = /* @__PURE__ */ new Map();
class s$3 {
  constructor(t2, n2) {
...
const o$4 = (t2) => new s$3(typeof t2 == "string" ? t2 : t2 + "", e$4), r$2 = (t2, ...n2) => {
 ...
 */
var s$2;
const e$3 = window.trustedTypes, r$1 = e$3 ? e$3.emptyScript : "", h$1 = window.reactiveElementPolyfillSupport, o$3 = { toAttribute(t2, i2) {
  switch (i2) {
    case Boolean:
      t2 = t2 ? r$1 : null;
      break;
 ...
 */
var t;
const i$1 = globalThis.trustedTypes, s$1 = i$1 ? i$1.createPolicy("lit-html", { createHTML: (t2) => t2 }) : void 0, e$2 = `lit$${(Math.random() + "").slice(9)}$`, o$2 = "?" + e$2, n$3 = `<${o$2}>`, l$2 = document, h = (t2 = "") => l$2.createComment(t2), r = (t2) => t2 === null || typeof t2 != "object" && typeof t2 != "function", d = Array.isArray, u = (t2) => {
  var i2;
...
z == null || z(E, N), ((t = globalThis.litHtmlVersions) !== null && t !== void 0 ? t : globalThis.litHtmlVersions = []).push("2.2.3");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
let SlideButton = class extends s {
  render() {
    return $`<button><slot></slot></button>`;
  }
};
SlideButton.styles = r$2`
    button {
        width: 2rem;
        height: 2rem;
        border-radius: 50%;
...
let SimpleCarousel = class extends s {
  constructor() {
    super(...arguments);
    this.slideIndex = 0;
  }
  ...
  navigateSlide() {
    for (let i2 = 0; i2 < this.slideElements.length; i2++) {
      if (i2 === this.slideIndex) {
        showSlide(this.slideElements[i2]);
      } else {
        hideSlide(this.slideElements[i2]);
      }
    }
  }
  changeSlide(offset) {
